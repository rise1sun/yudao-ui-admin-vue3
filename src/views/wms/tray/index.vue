...
<!--      <el-table-column label="id" align="center" prop="id" />-->
  ...
  <!-- 表单弹窗：添加/修改 -->
  <TrayForm ref="formRef" @success="getList" />
</template>
...
const getList = async () => {
  loading.value = true
  try {
    const data = await TrayApi.getTrayPage(queryParams)
...
const handleExport = async () => {
  try {
    ...
    const data = await TrayApi.exportTray(queryParams)
    download.excel(data, '托盘.xls')
  } catch {
  } finally {
